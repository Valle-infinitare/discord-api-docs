...
| author <sup>\[1\]</sup>              | [user](#DOCS_RESOURCES_USER/user-object) object                                                                                           | the author of this message (not guaranteed to be a valid user, see below)                                                                                                                                                                                               |
...
| mention_channels? <sup>\[3\]</sup>   | array of [channel mention](#DOCS_RESOURCES_CHANNEL/channel-mention-object) objects                                                        | channels specifically mentioned in this message                                                                                                                                                                                                                         |
| attachments <sup>\[2\]</sup>         | array of [attachment](#DOCS_RESOURCES_CHANNEL/attachment-object) objects                                                                  | any attached files                                                                                                                                                                                                                                                      |
| embeds <sup>\[2\]</sup>              | array of [embed](#DOCS_RESOURCES_CHANNEL/embed-object) objects                                                                            | any embedded content                                                                                                                                                                                                                                                    |
...
| message_snapshots? <sup>\[4\]</sup>  | array of [message snapshot](#DOCS_RESOURCES_CHANNEL/message-snapshot-object) objects                                                      | the message associated with the `message_reference`. This is a minimal subset of fields in a message (e.g. `author` is excluded.)                                                                                                                                       |
| referenced_message? <sup>\[5\]</sup> | ?[message object](#DOCS_RESOURCES_CHANNEL/message-object)                                                                                 | the message associated with the message_reference                                                                                                                                                                                                                       |
...
| components? <sup>\[2\]</sup>         | array of [message components](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/component-object)                                                     | sent if the message contains components like buttons, action rows, or other interactive components                                                                                                                                                                      |
...
| poll? <sup>\[2\]</sup>               | [poll](#DOCS_RESOURCES_POLL/poll-object) object                                                                                           | A poll!                                                                                                                                                                                                                                                                 |
...
\[4\] See [message reference types](#DOCS_RESOURCES_CHANNEL/message-reference-types)

\[5\] This field is only returned for messages with a `type` of `19` (REPLY) or `21` (THREAD_STARTER_MESSAGE). If the message is a reply but the `referenced_message` field is not present, the backend did not attempt to fetch the message that was being replied to, so its state is unknown. If the field exists but is null, the referenced message was deleted.
